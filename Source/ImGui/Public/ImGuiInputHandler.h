...
private:
	...
	void Initialize(FImGuiModuleManager1* InModuleManager, UGameViewportClient* InGameViewport, int32 InContextIndex);
	...
	FImGuiModuleManager1* ModuleManager = nullptr;
