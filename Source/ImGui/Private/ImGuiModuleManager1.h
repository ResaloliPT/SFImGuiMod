...
private:
	...
	FImGuiModuleManager1();
	~FImGuiModuleManager1();

	FImGuiModuleManager1(const FImGuiModuleManager1&) = delete;
	FImGuiModuleManager1& operator=(const FImGuiModuleManager1&) = delete;

	FImGuiModuleManager1(FImGuiModuleManager1&&) = delete;
	FImGuiModuleManager1& operator=(FImGuiModuleManager1&&) = delete;
